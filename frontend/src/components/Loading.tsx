...
const buttonVariantClasses = {
    primary: 'text-white bg-black border-2 border-black hover:bg-white hover:text-black',
    secondary: 'text-black bg-white border-2 border-gray-300 hover:border-black hover:bg-gray-50'
};
