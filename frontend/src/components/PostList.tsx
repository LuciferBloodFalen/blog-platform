...
export function PostList({
      ...
      <div className="bg-white shadow-lg rounded-xl border border-gray-100 p-8">
        <div className="animate-pulse">
          ...
          {[...Array(3)].map((_, i) => (
            <div
              key={i}
              className="border-b border-gray-100 py-8 last:border-b-0"
            >
  ...
  return (
    <div className="bg-white shadow-lg rounded-xl border border-gray-100">
      ...
      {posts.length === 0 && !loading && !error && <NoPostsEmptyState />}
        ...
        <>
          <div className="divide-y divide-gray-100">
            {posts.map((post) => (
              <div
                key={post.id}
                className="p-8 hover:bg-gray-50 transition-all duration-300 hover:shadow-sm"
              >
                <div className="flex items-start justify-between">
            ...
            <div className="px-8 py-6 bg-gray-50 border-t border-gray-100 flex items-center justify-between">
              ...
              <div className="flex space-x-3">
                <button
                  ...
                  className="inline-flex items-center px-6 py-3 text-sm font-semibold text-gray-700 bg-white border-2 border-gray-300 rounded-lg hover:bg-gray-50 hover:border-black transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-white disabled:hover:border-gray-300"
                >
                  <svg
                ...
                <button
                  ...
                  className="inline-flex items-center px-6 py-3 text-sm font-semibold text-white bg-black border-2 border-black rounded-lg hover:bg-gray-800 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-black"
                >
                  Next
                  <svg
